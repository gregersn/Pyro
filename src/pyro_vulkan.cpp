...
namespace Pyro {
    VulkanEngine::VulkanEngine(GLFWwindow *win, const uint w, const uint h) : window(win), width(w), height(h) {
        create_instance();
    ...
    void VulkanEngine::create_command_buffers() {
        std::cout << "Swap chain framebuffers: " << swapChainFramebuffers.size() << std::endl;
        ...
        for(size_t i = 0; i < commandBuffers.size(); i++) {
            ...
            if(vkBeginCommandBuffer(commandBuffers[i], &beginInfo) != VK_SUCCESS) {
                throw std::runtime_error("failed to begin recording from command buffer!");
            }
    ...
    void VulkanEngine::create_image_views() {
        std::cout << "Swap chain images: " << swapChainImages.size() << std::endl;
    ...
    static std::vector<char> readFile(const std::string& filename) {
        ...
        if(!file.is_open()) {
            throw std::runtime_error("failed top open file!");
        }
    ...
    void VulkanEngine::create_graphics_pipeline() {
        ...
        std::cout << "Size of fragment shader: " << fragShaderCode.size() << std::endl;
    ...
    void VulkanEngine::create_framebuffers() {
        std::cout << "Swap chain image views: " << swapChainImageViews.size() << std::endl;
