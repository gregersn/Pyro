...
TEST_CASE("GSN Graphics objects can be initialized", "[graphics-gsn]")
{
    SECTION("Create a graphics object")
    {
        Pyro::Graphics *graphics = Pyro::Graphics::create(400, 300, Pyro::GraphicsMode::GSN);
...
TEST_CASE("GSN Graphics can have backgrounds", "[graphics-gsn]")
{
    Pyro::Graphics *pg = Pyro::Graphics::create(4, 4, Pyro::GraphicsMode::GSN);
...
TEST_CASE("GSN Fill can be set", "[graphics-gsn]")
{
    Pyro::Graphics *pg = Pyro::Graphics::create(8, 8, Pyro::GraphicsMode::GSN);
...
TEST_CASE("GSN Stroke can be set", "[graphics-gsn]")
{
    Pyro::Graphics *pg = Pyro::Graphics::create(10, 1, Pyro::GraphicsMode::GSN);
...
TEST_CASE("GSN Shapes can be drawn", "[graphics-gsn]")
{
    Pyro::Graphics *pg = Pyro::Graphics::create(8, 8, Pyro::GraphicsMode::GSN);
...
TEST_CASE("GSN Select different color modes")
{
    Pyro::Graphics *pg = Pyro::Graphics::create(3, 3, Pyro::GraphicsMode::GSN);
...
TEST_CASE("GSN Save and load images")
{
    Pyro::Graphics *pg = Pyro::Graphics::create(4, 4, Pyro::GraphicsMode::GSN);
