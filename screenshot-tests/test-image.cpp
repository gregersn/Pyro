...
TEST_CASE("Images can be transformed")
{
    ...
    {
        std::filesystem::path filename = "image_rotate_PI.png";
    ...
    {
        std::filesystem::path filename = "image_rotate_HALF_PI.png";
    ...
    {
        std::filesystem::path filename = "image_rotate_QUARTER_PI.png";
    ...
    {
        std::filesystem::path filename = "image_rotate_1.png";
